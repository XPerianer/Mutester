...
class ReorderingEvaluation:
    def __init__(self, ordering: List[int], dataframe: DataFrame):
        ...
        assert len(self.ordering) == self.dataframe.shape[
            0], "Dataframe has not the same length as the provided ordering"
    ...
    # While this is not realistic, as probably some integration tests test the same as others,
